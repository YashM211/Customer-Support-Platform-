# Custome_Support E2E Test Bug Report
...
```bash
cd /Users/yi/Documents/Projects/Custome_Support-e2e-bugfix-integration && npm run typecheck:e2e
cd /Users/yi/Documents/Projects/Custome_Support-e2e-bugfix-integration && E2E_API_KEY=$DEEPSEEK_API_KEY E2E_JINA_API_KEY=$JINA_API_KEY npm run test:e2e
cd /Users/yi/Documents/Projects/Custome_Support-e2e-bugfix-integration && HOST_ALLOWED_URL=http://localhost:8080 HOST_BLOCKED_URL=http://localhost:8081 API_BASE_URL=http://localhost:8000 npm run test:e2e:widget
cd /Users/yi/Documents/Projects/Custome_Support-e2e-bugfix-integration && docker compose --profile prod up -d --build backend-prod frontend-prod nginx
cd /Users/yi/Documents/Projects/Custome_Support-e2e-bugfix-integration && E2E_ENV=prod API_BASE_URL=http://localhost E2E_API_KEY=$DEEPSEEK_API_KEY E2E_JINA_API_KEY=$JINA_API_KEY npm run test:e2e:prod
```
