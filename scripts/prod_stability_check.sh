...
TMP_DIR="${TMPDIR:-/tmp}/Custome_Support-prod-stability"
...
import json
items = [
  {"question": "What is Custome_Support autoresearch?", "answer": "A production stability validation run."},
...
print(json.dumps({
  ...
  "message": "Please answer briefly: what is Custome_Support autoresearch?"
}))
PY
)
