...
async def lifespan(app: FastAPI):
    test_mode = os.getenv("Custome_Support_TEST_MODE") == "1"
...
# Logo 路由 - 用于聊天窗口显示
@app.get("/Custome_Support-logo.png")
async def get_logo():
    """返回 widget logo 文件"""
    logo_path = os.path.join(os.path.dirname(__file__), "static", "Custome_Support-logo.png")
